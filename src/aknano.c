...
void aknano_init(struct aknano_settings *aknano_settings)
{
    ...
    bool registrationOk;
#endif
    LogInfo((AKNANO_TEST_MESSAGE_PREAMBLE "/REVISION=v%u AKNANO_HASH=" AKNANO_COMMIT_ID, aknano_settings->running_version));
    LogInfo((AKNANO_TEST_MESSAGE_PREAMBLE "/REVISION=v%u MANIFEST_HASH=" AKNANO_MANIFEST_COMMIT_ID, aknano_settings->running_version));
    ...
    aknano_delay(100);
    LogInfo((AKNANO_TEST_MESSAGE_PREAMBLE "/REVISION=v%u UUID=%s", aknano_settings->running_version, aknano_settings->uuid));
    // LogInfo((AKNANO_TEST_MESSAGE_PREAMBLE "aknano_init RUNNING_VERSION=%u", aknano_settings->running_version));
    LogInfo((AKNANO_TEST_MESSAGE_PREAMBLE "/REVISION=v%u RUNNING_FROM_SLOT=%u", aknano_settings->running_version, aknano_settings->image_position));
