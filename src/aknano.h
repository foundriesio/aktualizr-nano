...
#define AKNANO_MAX_TAG_LENGTH 40
#define AKNANO_MAX_HWID_LENGTH 20
#define AKNANO_MAX_TARGET_NAME_LENGTH AKNANO_MAX_TAG_LENGTH + AKNANO_MAX_HWID_LENGTH + 1
...
#define AKNANO_MAX_UPDATE_CORRELATION_ID_LENGTH AKNANO_MAX_TARGET_NAME_LENGTH + AKNANO_MAX_UUID_LENGTH + 1
